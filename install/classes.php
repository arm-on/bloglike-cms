...
class post extends db_control{
    ...
    {
        $conn = new PDO("mysql:host=$this->host;dbname=$this->dbname;charset=utf8", $this->username, $this->pass);
        $stmt=$conn->prepare("SELECT ttl FROM $this->table WHERE ct=:cat limit $this->limit");
        $stmt->bindParam(':cat',$this->cat);
        $stmt->execute();
        $result=$stmt->fetch(PDO::FETCH_ASSOC);
        $conn=null;
    ...
    {
        $conn = new PDO("mysql:host=$this->host;dbname=$this->dbname;charset=utf8", $this->username, $this->pass);
        $stmt=$conn->prepare("SELECT des FROM $this->table WHERE ct=:cat limit $this->limit");
        $stmt->bindParam(':cat',$this->cat);
        $stmt->execute();
        $result=$stmt->fetch(PDO::FETCH_ASSOC);
        $conn=null;
    ...
    {
        $conn = new PDO("mysql:host=$this->host;dbname=$this->dbname;charset=utf8", $this->username, $this->pass);
        $stmt=$conn->prepare("SELECT id FROM $this->table WHERE ct=:cat limit $this->limit");
        $stmt->bindParam(':cat',$this->cat);
        $stmt->execute();
        $result=$stmt->fetch(PDO::FETCH_ASSOC);
        $conn=null;
    ...
    {
        $conn = new PDO("mysql:host=$this->host;dbname=$this->dbname;charset=utf8", $this->username, $this->pass);
        $stmt=$conn->prepare("SELECT dt FROM $this->table WHERE ct=:cat limit $this->limit");
        $stmt->bindParam(':cat',$this->cat);
        $stmt->execute();
        $result=$stmt->fetch(PDO::FETCH_ASSOC);
        $conn=null;
    ...
    {
        $conn = new PDO("mysql:host=$this->host;dbname=$this->dbname;charset=utf8", $this->username, $this->pass);
        $stmt=$conn->prepare("SELECT img FROM $this->table WHERE ct=:cat limit $this->limit");
        $stmt->bindParam(':cat',$this->cat);
        $stmt->execute();
        $result=$stmt->fetch(PDO::FETCH_ASSOC);
        $conn=null;
...
class mct extends db_control{
    ...
    {
        $conn = new PDO("mysql:host=$this->host;dbname=$this->dbname;charset=utf8", $this->username, $this->pass);
        $stmt=$conn->prepare("SELECT $this->field FROM $this->table WHERE (type=:type)  ORDER BY -id LIMIT $this->limit");
        $stmt->bindParam(':type',$this->type);
        $stmt->execute();
        $result=$stmt->fetch(PDO::FETCH_ASSOC);
        $conn=null;
    ...
    {
        $conn = new PDO("mysql:host=$this->host;dbname=$this->dbname;charset=utf8", $this->username, $this->pass);
        $stmt=$conn->prepare("UPDATE $this->table SET type='activecomment' WHERE (id=:id)");
        $stmt->bindParam(':id',$this->id);
        $stmt->execute();
        $conn=null;
    }
...
function get_comment_all($field,$limit)
{
    $mct=new mct();
    $mct->host=$GLOBALS['host'];
    $mct->table=$GLOBALS['mct_table'];
