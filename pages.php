				...
				<section id="main" class="container">
					...
					<div class="row">
						<div class="8u important(collapse)">
							...
							<!-- Content -->
							<?php if(isset($_GET['title'])){$i=BL_PAGE_REALID_BY_TITLE($_GET['title']);echo'
								<section id="content" class="box">
									<h3 style="font-size:16pt;font-weight: 400">'.BL_PAGE_TITLE_BY_REAL_ID($i).'</h3><hr>
									<h3 style="font-size:13pt;font-weight: 400">نوشته شده توسط '.BL_PAGE_AUTHOR_BY_REAL_ID($i,"return").'</h3>
									<p style="font-size: 14pt !important;font-weight: 300">'.BL_PAGE_DES_BY_REAL_ID($i).'</p>
								</section>
							';}?>
