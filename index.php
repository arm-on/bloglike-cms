				...
				<section id="main" class="container">
					...
					<div class="row">
						<div class="8u important(collapse)">
							...
							<!-- Content -->
							<?php $hmpp=2;$hmp=(BL_POST_COUNT("return")%$hmpp==0)?BL_POST_COUNT("return")/$hmpp:BL_POST_COUNT("return")/$hmpp+1;$hmpts=7;
                        if(!isset($_GET['page'])) $_GET['page']=1;for($i=($_GET['page']-1)*$hmpp+1;($i<=$_GET['page']*$hmpp)&&($i<=BL_POST_COUNT("return"));$i++){
                        echo'
								<section id="content" class="box">
									<a href="post/'.BL_POST_TITLE($i,"return").'" class="image fit"><img src="'.BL_POST_IMG($i,"return").'" alt="" /></a>
									...
									<ul class="actions">
												<li><a href="post/'.BL_POST_TITLE($i,"return").'" class="button small">ادامه مطلب</a></li>
											</ul>
								</section>
							';}?>
								<section id="content" class="box">
